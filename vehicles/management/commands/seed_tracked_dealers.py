...
TRACKED_DEALERS = (
    ...
    ("Auto System", "autosystem", "https://www.polovniautomobili.com/autosystem", Dealer.InventoryType.USED),
    ("Autokomerc", "autokomerc", "https://www.polovniautomobili.com/autokomerc", Dealer.InventoryType.USED),
    ("Autoland", "autoland", "https://www.polovniautomobili.com/autoland", Dealer.InventoryType.USED),
    ("Balkan Car Sales", "balkan-car-sales", "https://www.polovniautomobili.com/balkan-car-sales", Dealer.InventoryType.USED),
    ...
    ("Fiba Auto", "fiba-auto", "https://www.polovniautomobili.com/fiba-auto", Dealer.InventoryType.USED),
    ("Force Luxury Cars", "force-luxury-cars", "https://www.polovniautomobili.com/force-luxury-cars", Dealer.InventoryType.USED),
    ("Holliday", "holliday", "https://www.polovniautomobili.com/holliday", Dealer.InventoryType.USED),
    ("JP Company", "jpcompany", "https://www.polovniautomobili.com/jpcompany", Dealer.InventoryType.USED),
    ("NBG Autos", "nbg-autos", "https://www.polovniautomobili.com/nbg-autos", Dealer.InventoryType.USED),
    ("Stojanov", "stojanov", "https://www.polovniautomobili.com/stojanov", Dealer.InventoryType.USED),
    ("Tree M Auto", "tree-m-auto", "https://www.polovniautomobili.com/tree-m-auto", Dealer.InventoryType.USED),
